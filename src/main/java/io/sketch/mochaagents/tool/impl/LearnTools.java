...
public final class LearnTools {
    ...
    public static final class UpdateCheckpoint extends AbstractTool {
        ...
        public UpdateCheckpoint(MemoryManager m) { super(builder("update_checkpoint", "Set key_info and related_sop for the current task.", SecurityLevel.LOW)); this.mem = m; }
        ...
        @Override public Object call(Map<String, Object> a) { String ki = (String) a.get("key_info"); String sop = (String) a.get("related_sop"); mem.checkpoint(ki, sop); return Map.of("status", "updated"); }
    }

    public static final class SettleLongTerm extends AbstractTool {
        private final MemoryManager mem;
        public SettleLongTerm(MemoryManager m) { super(builder("start_long_term_update", "Persist a VERIFIED fact to global memory.", SecurityLevel.LOW)); this.mem = m; }
