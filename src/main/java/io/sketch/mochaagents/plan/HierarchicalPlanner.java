...
public class HierarchicalPlanner implements PlanningStrategy {
    ...
    public HierarchicalPlanner(Model model) { this(model, 3); }
    public HierarchicalPlanner(Model model, int maxDepth) { this.model = model; this.maxDepth = maxDepth; }
